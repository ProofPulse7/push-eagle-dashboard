...
import { BackInStockComposer } from '@/components/automations/back-in-stock-composer';
    ...
    notifications: [
        {
            ...
            notification: {
                ...
                message: "{{product_name}} is now back in stock. Buy now before it runs out of stock again",
