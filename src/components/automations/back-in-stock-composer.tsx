...
const BackInStockEditorPanel = ({ handleImageUpload, setEditingState }: {
        ...
        <div className="p-4 space-y-6">
             <div className="space-y-1.5">
                ...
                <div className="relative">
                    <Input id="title" placeholder="Back in Stock Alert" value={title} onChange={e => setTitle(e.target.value)} className="pr-10" />
                    <Popover>
            ...
            <div className="space-y-1.5">
                ...
                <div className="relative">
                    <Textarea
                        ...
                        placeholder="{{product_name}} is now back in stock. Buy now before it runs out of stock again"
                        value={message}
...
export function BackInStockComposer() {
    const { 
            ...
            <div className="bg-card border-r flex flex-col h-screen">
                ...
                <div className="p-4 border-b flex items-center gap-4 shrink-0">
                    <Button variant="outline" size="icon" asChild>
                        <Link href="/automations/back-in-stock">
                            <ArrowLeft className="h-4 w-4" />
                        </Link>
                    </Button>
                    <h2 className="text-lg font-semibold">Back in stock</h2>
                </div>

                <ScrollArea type="always" className="flex-grow campaign-creator-scroll-area">
                   <BackInStockEditorPanel handleImageUpload={handleImageUpload} setEditingState={setEditingState} />
                </ScrollArea>
            </div>
