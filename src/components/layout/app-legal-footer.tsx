  ...
  return (
    <footer className="border-t px-4 py-3 text-center text-xs text-muted-foreground sm:px-6 md:px-8">
      <p>
        ...
        <Link href={LEGAL_LINKS.privacyPolicy} target="_blank" rel="noopener noreferrer" className="underline underline-offset-2">
          Privacy policy
        </Link>
        {' · '}
        <Link href={LEGAL_LINKS.termsOfService} target="_blank" rel="noopener noreferrer" className="underline underline-offset-2">
          Terms of service
        </Link>
        {' · '}
